...
function initEntranceScreen() {
    ...
    function handleEntranceTransition() {
    ...
    // 添加点击事件监听器
    entrance.addEventListener('click', handleEntranceTransition);
    entrance.addEventListener('touchstart', handleEntranceTransition);
} 